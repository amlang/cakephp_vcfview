...
VcfView loves to welcome your contributions. There are several ways to help out:
...
* Contribute to the [documentation](https://github.com/amlang/cakephp_vcfview/tree/gh-pages)
...
To run the sniffs for CakePHP coding standards
    ...
    phpcs -p --extensions=php --standard=CakePHP ./View/VcfView.php
...
* [Bug tracker](https://github.com/amlang/cakephp_vcfview/issues)
